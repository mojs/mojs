...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transit = __webpack_require__(5);

	var _transit2 = _interopRequireDefault(_transit);

	var _swirl = __webpack_require__(6);
	...
	var Burst = function (_Tunable) {
	  ...
	  (0, _createClass3.default)(Burst, [{
	    ...
	    */
	    ...
	    key: '_vars',
	    value: function _vars() {
	      (0, _get3.default)((0, _getPrototypeOf2.default)(Burst.prototype), '_vars', this).call(this);
	      ...
	      if (!_h2.default.isTweenProp(key) && !this._nonMergeProps[key]) {
	        ...
	        if (this._isDelta(endValue)) {
	          ...
	          if (this._isDelta(startValue)) {
	            ...
	            return (0, _defineProperty3.default)({}, _h2.default.getDeltaEnd(startValue), parsedEndValue);
	            // if both start and end value are not ∆ - make ∆
	          } else {
	              return (0, _defineProperty3.default)({}, startValue, parsedEndValue);
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Circle = __webpack_require__(39);

	Line = __webpack_require__(40);

	Zigzag = __webpack_require__(41);

	Rect = __webpack_require__(42);

	Polygon = __webpack_require__(43);

	Cross = __webpack_require__(44);

	Equal = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getOwnPropertyDescriptor = __webpack_require__(49);
