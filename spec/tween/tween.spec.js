...
//       expect(props.onComplete.calls.count()).toBe(1);
//
//       endTime -= 8; // set time to the middle of the frame
//
//       endTime -= 16
//       tween.update(endTime);
//
...
//       expect(props.onComplete.calls.count()).toBe(1);
//
//       expect(tween.update(endTime - duration - 16)).toBe(true);
//
//       expect(props.onStart.calls.count()).toBe(1);
//       expect(props.onRepeatStart.calls.count()).toBe(1);
...
//
//       endTime -= 16; // -8
//       expect(tween.update(endTime)).toBe(true);
//
//       expect(props.onStart.calls.count()).toBe(1);
//       expect(props.onRepeatStart.calls.count()).toBe(1);
//       expect(props.onUpdate.calls.count()).toBe(4);
...
//     });
//
//     it('should pass progress to `onUpdate` #repeat #delay #duration ->', function () {
//       var progress = -1;
//       var duration = 64;
//       var delay = 32;
//       var repeat = 2;
...
//     });
//
//     it('should set progress to latter if `onRepeatComplete` + `onRepeatStart` #repeat #duration ->', function () {
//       var progress = -1;
//       var duration = 64;
//       var repeat = 2;
//       var options = {
...
//       expect(progress).toBeCloseTo(0.875, 3);
//
//       startTime += 16; // 64 + 16 = 72, 1st frame
//       tween.update(startTime);
//
//       expect(progress).toBeCloseTo(0.125, 3);
//     });
//   });
//
//   describe('`onUpdate` progress #backward ->', function() {
//     it('should pass progress to `onUpdate` ->', function () {
//       // var progress = -1;
//       // var options = {
//       //   duration: 48,
