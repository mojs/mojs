...
describe 'Shape ->', ->
  ...
  describe '_render method ->', ->
    ...
    it 'should set _isRendered to true method', ->
      byte = new Byte radius: 25
  ...
  #   #   byte = new Byte radius: 25
  #   #   spyOn byte.shape, 'setProp'
  #   #   byte._draw()
  #   #   expect(byte.shape.setProp).toHaveBeenCalled()
  ...
  #     byte._draw()
  #     expect(byte.shape._props.x).toBe byte._origin.x
  #     expect(byte.shape._props.y).toBe byte._origin.y
  #     expect(byte.shape._props.rx).toBe byte._props.rx
  #     expect(byte.shape._props.ry).toBe byte._props.ry
  #     expect(byte.shape._props.stroke).toBe byte._props.stroke
  #     expect(byte.shape._props['stroke-width']).toBe byte._props.strokeWidth
  #     expect(byte.shape._props['stroke-opacity']).toBe byte._props.strokeOpacity
  #     expect(byte.shape._props['stroke-linecap']).toBe byte._props.strokeLinecap
  #     expect(byte.shape._props['stroke-dasharray']).toBe byte._props.strokeDasharray[0].value + ' '
  #     expect(byte.shape._props['stroke-dashoffset']).toBe byte._props.strokeDashoffset[0].value + ' '
  #     expect(byte.shape._props['fill']).toBe byte._props.fill
  #     expect(byte.shape._props['fill-opacity']).toBe byte._props.fillOpacity
  #     expect(byte.shape._props['radius']).toBe byte._props.radius
  #     expect(byte.shape._props['radiusX']).toBe byte._props.radiusX
  #     expect(byte.shape._props['radiusY']).toBe byte._props.radiusY
  #     expect(byte.shape._props['points']).toBe byte._props.points
  #     # old
  #     # expect(byte.shape._props['transform']).toBe byte._calcShapeTransform()

  #   it 'should set x/y to center', ->
  #     byte = new Byte radius: 25
  #     byte._draw()
  #     expect(byte.shape._props.x).toBe byte._props.center
  #     expect(byte.shape._props.y).toBe byte._props.center
  #   it 'should set x/y to props.x/props.y if context was passed', ->
  #     byte = new Byte radius: 25, ctx: svg
  #     byte._draw()
  #     expect(byte.shape._props.x).toBe parseFloat byte._props.x
  #     expect(byte.shape._props.y).toBe parseFloat byte._props.y
  #   it 'should call bit._draw method', ->
  #     byte = new Byte radius: 25
  #     spyOn byte.shape, '_draw'
  #     byte._draw()
  #     expect(byte.shape._draw).toHaveBeenCalled()
  ...
  #     byte = new Byte ctx: svg
  #     expect(byte.el).toBe byte.shape.el
  ...
  #     expect(tr._props.size).toBe tr.shape._props.ratio
  ...
  #     tr._props.size = 1
  #     tr._increaseSizeWithBitRatio()
  #     expect(tr._props.size).toBe tr.shape._props.ratio + 2*gap
  ...
  #     byte = new Byte radius: 25
  #     expect(byte.shape).toBeDefined()
  #     expect(byte.shape._o.isDrawLess).toBe true
  #   it 'should create bit based on shape option or fallback to circle', ->
  #     byte = new Byte
  #       radius:  25
  #       shape:   'rect'
  #     byte2 = new Byte radius: 25
  #     expect(byte.shape._props.tag).toBe  'rect'
  #     expect(byte2.shape._props.tag).toBe 'ellipse'
  ...
  describe '_createShape method', ->
    it 'should create shape module based on `_props` shape', ->
      ...
      byte.shape = null
      byte._createShape()
      expect(byte.shape instanceof mojs.shapesMap.rect).toBe true
    ...
    it 'should send `width` and `height` to the `shape` module', ->
      ...
      expect(byte.shape._props.parent).toBe byte.el
