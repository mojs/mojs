mojs = mojs.default;
const { Tween, __helpers } = mojs;
const { ClassProto, tweener } = __helpers;

// prevent tweener from sleeping on page blur - for testing in real browser
tweener.caffeinate();
...
describe('Tween ->', function() {
  describe('extention ->', function() {
    return it('should extend `ProtoClass` class', function() {
      var tw = new Tween;
      return expect(tw instanceof ClassProto).toBe(true);
    });
  });
  ...
  //   return it('should increment _name on tweener', function() {
  //     var t;
  //     tweener['_Tweens'] = void 0;
  //     t = new Tween;
  ...
  describe('update method ->', function() {
    it('should update progress', function() {
      ...
      t._setStartTime();
      var time = t._props.startTime + 199;
      t.update(time);
      expect(t.progress).toBe(0);
    ...
    it('should update progress with repeat', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 1399);
      expect(t.progress).toBeCloseTo(0);
      t.update(t._props.startTime + 1400);
      expect(t.progress).toBeCloseTo(.2);
      t.update(t._props.startTime + 2700);
      expect(t.progress).toBeCloseTo(.3);
      t.update(t._props.startTime + 3400);
    ...
    it('should update progress to 1 if in delay gap and previous time value was smaller then the current one', function() {
      ...
      t.update(t._props.startTime + 500);
      t.update(t._props.startTime + 1100);
      return expect(t.progress).toBe(1);
    });
    it('should update progress to 1 if in delay gap and previous time value was bigger then the current one', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 1300);
      t.update(t._props.startTime + 1100);
    ...
    it('should update progress to 1 on the end', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 200);
      expect(t.progress).toBeCloseTo(0);
      t.update(t._props.startTime + 500);
      expect(t.progress).toBeCloseTo(.5);
      t.update(t._props.startTime + 1000);
      return expect(t.progress).toBeCloseTo(1, 3);
    });
    it('should return true on the end', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + t._props.duration / 2);
      returnValue = t.update(t._props.startTime + 1000);
      expect(t.progress).toBeCloseTo(1, 3);
      expect(t._isCompleted).toBe(true);
      expect(t._isRepeatCompleted).toBe(true);
    ...
    it('should treat very close to `endTime`, `time` as `endTime`', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime);
      spyOn(t, '_complete').and.callThrough();
      returnValue = t.update(t._props.endTime - 0.000000001);
      expect(t.progress).toBeCloseTo(1, 3);
      expect(t._isCompleted).toBe(true);
      expect(t._isRepeatCompleted).toBe(true);
      return expect(returnValue).toBe(true);
    ...
    it('should return true on the start', function() {
      ...
      t.update(t._props.startTime + t._props.duration / 2);
      returnValue = t.update(t._props.startTime - 1000);
      expect(t.progress).toBeCloseTo(0, 3);
      return expect(returnValue).toBe(true);
    });
    ...
    it('should not call update method if timeline isnt active but was "+"', function() {
      ...
      t.update(t._props.startTime + 500);
      expect(t._isInActiveArea).toBe(true);
      t.update(t._props.startTime + 1500);
      expect(t._isInActiveArea).toBe(false);
    ...
    it('should set Tween to the end if Tween ended', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 200);
      t.update(t._props.startTime + 1200);
    ...
    it('should save _onEdge property', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime);
      t.update(t._props.startTime + duration / 2);
      expect(t._onEdge).toBe(0);
      t.update(t._props.startTime + duration + 1);
    ...
    it('should save _onEdge property || reverse', function() {
      ...
      t._setStartTime();
      t.update(t._props.endTime - 1);
      t.update(t._props.endTime - duration / 2);
      expect(t._onEdge).toBe(0);
      t.update(t._props.endTime - duration - 1);
      expect(t._onEdge).toBe(-1);
      t.update(t._props.endTime - duration - 2);
      return expect(t._onEdge).toBe(0);
    });
    it('should receive _prevTime', function() {
      ...
      t.update(t._props.startTime + 1300, time, prevTime);
  ...
  //     tm._setStartTime();
  //     tm.update(tm._props.startTime);
  //     tm.update(tm._props.startTime + 10);
  ...
  //     spyOn(t._timelines[0], 'update');
  //     spyOn(t._timelines[1], 'update');
  //     t.update(20, 10, false, 1);
  //     expect(t._timelines[0].update).toHaveBeenCalledWith(20, 10, false, 1);
  //     return expect(t._timelines[1].update).toHaveBeenCalledWith(20, 10, false, 1);
  //   });
  ...
  describe('onUpdate callback ->', function() {
    ...
    it('should call onUpdate callback with the current progress', function() {
      ...
      spyOn(t._props, 'onUpdate');
      t._setStartTime();
      t.update(t._props.startTime + 499);
      t.update(t._props.startTime + 500);
    ...
    it('should have the right scope', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 199);
      t.update(t._props.startTime + 200);
    ...
    it('should not be called on delay', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + t._props.duration + 50);
      t.update(t._props.startTime + t._props.duration + 100);
      t.update(t._props.startTime + t._props.duration + 150);
    ...
    it('should be called just once on delay', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 50);
      t.update(t._props.startTime + t._props.duration / 2);
      spyOn(t._props, 'onUpdate').and.callThrough();
      t.update(t._props.startTime + t._props.duration + 50);
      t.update(t._props.startTime + t._props.duration + 100);
    ...
    it('should not fire when completed and return to "-" inactive area', function() {
      ...
      t.update(t._props.startTime);
      t.update(t._props.startTime + t._props.duration / 2);
      t.update(t._props.startTime + t._props.duration);
    ...
    it('should be called with 1 and 0 on each repeat period', function() {
      ...
      t = new Tween({
        ...
        onUpdate: function(p, ep, isForward) {
          ...
          updateValue = p;
          (Math.abs(p - 0) < smallNumber) && zeroCnt++;
          (Math.abs(p - 1) < smallNumber) && oneCnt++;
        },
      ...
      var startTime = 0;
      t._setStartTime(startTime);
      timeShift = 0;
      t.update(startTime + timeShift);
      ...
      t.update(startTime + timeShift + (duration / 2));
      expect(updateValue).toBeCloseTo(.5, 3);
      ...
      t.update(startTime + timeShift + duration);
      expect(updateValue).toBeCloseTo(0, 3);
      expect(updateDirection).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(0);
      ...
      expect(firstUpdateDirection).toBe(true);
      t.update(startTime + timeShift + duration);
      expect(updateValue).toBeCloseTo(1, 3);
      expect(updateDirection).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
    ...
    it('should be called with 1 and 0 on each repeat period if missed time', function() {
      ...
      gap = 5;
      timeShift = 0;
      t.update(t._props.startTime + timeShift + gap);
      expect(updateValue).toBe(null);
      expect(updateDirection).toBe(null);
      expect(t._wasUknownUpdate).toBe(true);
      expect(oneCnt).toBe(0);
      ...
      expect(firstUpdateCnt).toBe(0);
      expect(firstUpdateDirection).toBe(null);
      t.update(t._props.startTime + timeShift + (duration / 2));
      expect(updateValue).toBeCloseTo(.5, 3);
      expect(updateDirection).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(0);
      ...
      expect(firstUpdateCnt).toBe(1);
      expect(firstUpdateDirection).toBe(true);
      t.update(t._props.startTime + timeShift + duration - gap);
    ...
    it('should be called with 1 and 0 on each repeat period if delay', function() {
      ...
      t._setStartTime();
      timeShift = 0;
      t.update(t._props.startTime + timeShift + smallNumber);
      ...
      t.update(t._props.startTime + timeShift + duration + smallNumber);
      expect(updateValue).toBeCloseTo(1, 3);
      expect(updateDirection).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(1);
      ...
      t.update(t._props.startTime + timeShift + duration);
      expect(updateValue).toBeCloseTo(1, 3);
      expect(updateDirection).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
      ...
      t.update(t._props.startTime + timeShift + duration + delay / 2);
      expect(updateValue).toBeCloseTo(1, 3);
      expect(updateDirection).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(3);
    ...
    it('should be called with 1 and 0 on each repeat period if in delay', function() {
      ...
      t._setStartTime();
      timeShift = 0;
      t.update(t._props.startTime + timeShift);
      expect(updateValue).toBe(null);
      expect(updateDirection).toBe(null);
      expect(t._wasUknownUpdate).toBe(true);
      expect(oneCnt).toBe(0);
      ...
      expect(firstUpdateDirection).toBe(true);
      timeShift = duration + delay;
      t.update(t._props.startTime + timeShift + 10);
      ...
      expect(firstUpdateCnt).toBe(1);
      expect(firstUpdateDirection).toBe(true);
      t.update(t._props.startTime + timeShift + duration + delay / 2 + 10);
      expect(updateValue).toBeCloseTo(1, 3);
      expect(updateDirection).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(3);
    ...
    it('should be called with 0 and 1 on each repeat period if missed time || reverse', function() {
      ...
      expect(firstUpdateDirection).toBe(true);
      t.update(t._props.startTime - gap);
      expect(updateValue).toBeCloseTo(0, 3);
      expect(updateDirection).toBe(false);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(0);
      ...
      expect(firstUpdateCnt).toBe(2);
      expect(firstUpdateDirection).toBe(true);
      t.update(t._props.startTime - gap - 15);
      expect(updateValue).toBeCloseTo(0, 3);
      expect(updateDirection).toBe(false);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(0);
    ...
    it('should be called with 0 and 1 on each repeat period if in delay || reverse', function() {
      ...
      t.update(t._props.startTime + timeShift + 5);
      expect(updateValue).toBe(null);
      expect(updateDirection).toBe(null);
      expect(t._wasUknownUpdate).toBe(true);
      expect(zeroCnt).toBe(0);
      ...
      expect(firstUpdateCnt).toBe(1);
      expect(firstUpdateDirection).toBe(false);
      t.update(t._props.startTime + timeShift - duration - 5);
      expect(updateValue).toBeCloseTo(0, 3);
      expect(updateDirection).toBe(false);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(0);
      ...
      expect(firstUpdateCnt).toBe(1);
      expect(firstUpdateDirection).toBe(false);
      t.update(t._props.startTime + timeShift - duration - 15);
      expect(updateValue).toBeCloseTo(0, 3);
      expect(updateDirection).toBe(false);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(0);
    ...
    it('should be called with 0 and 1 on each repeat period if delay || reverse', function() {
      ...
      expect(firstUpdateCnt).toBe(1);
      expect(firstUpdateDirection).toBe(false);
      t.update(t._props.startTime + timeShift - duration - 10);
      expect(updateValue).toBeCloseTo(0, 3);
      expect(updateDirection).toBe(false);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(0);
    ...
    it('should be called with 1 and 0 on each repeat period || yoyo', function() {
      ...
      expect(firstUpdateDirection).toBe(true);
      timeShift = duration;
      t.update(t._props.startTime + timeShift + (duration / 4));
    ...
    it('should be called with 1 and 0 on each repeat period if delay || yoyo', function() {
      ...
      t.update(t._props.startTime + timeShift + (duration / 2) + smallNumber);
      expect(updateValue).toBeCloseTo(.5, 3);
      expect(updateDirection).toBe(true);
      expect(updateYoyo).toBe(false);
      expect(t._wasUknownUpdate).toBe(false);
      ...
      t.update(t._props.startTime + timeShift + (duration / 4));
      expect(updateValue).toBeCloseTo(.75, 3);
      expect(updateDirection).toBe(true);
      expect(updateYoyo).toBe(true);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(2);
      ...
      expect(firstUpdateYoyo).toBe(false);
      t.update(t._props.startTime + timeShift + (duration / 4));
      expect(updateValue).toBeCloseTo(.25, 3);
      expect(updateDirection).toBe(true);
      expect(updateYoyo).toBe(false);
      expect(t._wasUknownUpdate).toBe(false);
      expect(oneCnt).toBe(2);
  ...
  describe('specific _update behaviour', function() {
    ...
    //it('should not call onComplete and onRepeatComplete on start', function() {
    //   var et, st, tm, tw;
    //   tm = new mojs.Timeline({
    //     repeat: 1,
    //     isYoyo: true
    ...
    //   tm.update(tm._props.endTime - .0000000000001);
  ...
  describe('_getPeriod method ->', function() {
    it('should get current period', function() {
      ...
      expect(t._getPeriod(t._props.startTime + smallNumber)).toBe(0);
      expect(t._getPeriod(t._props.startTime + smallNumber + duration / 2)).toBe(0);
      expect(t._getPeriod(t._props.startTime - smallNumber + duration)).toBe(0);
      period = duration + delay;
      expect(t._getPeriod(t._props.startTime + period - delay / 2)).toBe('delay');
      expect(t._delayT).toBe(1);
      expect(t._getPeriod(t._props.startTime + period + smallNumber)).toBe(1);
      expect(t._getPeriod(t._props.startTime + period + duration / 2)).toBe(1);
      expect(t._getPeriod(t._props.startTime + period + duration - smallNumber)).toBe(1);
      period = 2 * (duration + delay);
      expect(t._getPeriod(t._props.startTime + period - delay / 2)).toBe('delay');
      expect(t._delayT).toBe(2);
      expect(t._getPeriod(t._props.startTime + period + smallNumber)).toBe(2);
      expect(t._getPeriod(t._props.startTime + period + duration / 2)).toBe(2);
      expect(t._getPeriod(t._props.startTime + period + duration - smallNumber)).toBe(2);
      period = 3 * (duration + delay);
      expect(t._getPeriod(t._props.startTime + period - delay / 2)).toBe('delay');
      expect(t._delayT).toBe(3);
      expect(t._getPeriod(t._props.startTime + period + smallNumber)).toBe(3);
      expect(t._getPeriod(t._props.startTime + period + duration / 2)).toBe(3);
      expect(t._getPeriod(t._props.startTime + period + duration - smallNumber)).toBe(3);
    });
    it('should get the current period with no delay', function() {
      ...
      expect(t._getPeriod(t._props.startTime + duration + smallNumber)).toBe(1);
      timeShift = duration;
      ...
      expect(t._getPeriod(t._props.startTime + timeShift + duration + smallNumber)).toBe(2);
      timeShift = 2 * duration;
      ...
      expect(t._getPeriod(t._props.startTime + timeShift + duration + smallNumber)).toBe(3);
      timeShift = 3 * duration;
      ...
      expect(t._getPeriod(t._props.startTime + timeShift + duration + smallNumber)).toBe(4);
    });
  ...
  describe('onComplete callback ->', function() {
    ...
    it('should call onComplete callback', function() {
      ...
      spyOn(t._props, 'onComplete');
      t.update(t._props.startTime + 50);
      t.update(t._props.startTime + 51);
      t.update(t._props.startTime + 101);
    ...
    it('should be called just once', function() {
      ...
      spyOn(t._props, 'onComplete');
      t.update(t._props.startTime + 0);
      t.update(t._props.startTime + 10);
      t.update(t._props.startTime + 20);
      t.update(t._props.startTime + 30);
      t.update(t._props.startTime + 34);
    ...
    //   tm._setStartTime();
    //   spyOn(t._props, 'onComplete');
    //   tm.update(t._props.startTime + 0);
    //   tm.update(t._props.startTime + duration / 2);
    //   tm.update(t._props.startTime + duration);
    //   expect(t._props.onComplete).toHaveBeenCalledWith(true, false);
    //   return expect(t._props.onComplete.calls.count()).toBe(1);
    // });
    ...
    //   tm.add(t1, t2);
    //   tm._setStartTime();
    //   tm.update(t1._props.startTime);
    //   tm.update(t1._props.startTime + duration / 2);
    //   tm.update(t1._props.startTime + duration + delay / 2);
    //   tm.update(t1._props.startTime + duration + delay + 1);
    //   tm.update(t1._props.startTime + 2 * duration + delay / 2);
    //   tm.update(t1._props.startTime + 2 * (duration + delay));
    //   tm.update(t1._props.startTime + 2 * (duration + delay) + delay);
    //   tm.update(t1._props.startTime + 2 * (duration + delay) + 2 * delay);
    //   tm.update(t1._props.startTime + 2 * (duration + delay) + 3 * delay);
    //   tm.update(t1._props.startTime + 2 * (duration + delay) + 4 * delay);
    ...
    it('should reset isCompleted flag', function() {
      ...
      t.update(t._props.startTime + 10);
      t.update(t._props.startTime + 11);
    ...
    it('should have the right scope', function() {
      ...
      t._setStartTime().update(t._props.startTime + 2);
      t._setStartTime().update(t._props.startTime + 3);
      t._setStartTime().update(t._props.startTime + 11);
      return expect(isRightScope).toBe(true);
    });
    return it('should fire after the last onUpdate', function(dfr) {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 1);
      t.update(t._props.startTime + 2);
      return t.update(t._props.startTime + 32);
    });
  });
  describe('onStart callback ->', function() {
    ...
    it('should restart if tween was completed', function() {
      ...
      t.update(t._props.startTime + t._props.duration / 2);
      expect(startCnt).toBe(0);
      t.update(t._props.startTime + t._props.duration / 2 + 10);
      expect(startCnt).toBe(1);
      t.update(t._props.startTime + t._props.duration);
      expect(startCnt).toBe(1);
      t.update(t._props.startTime - 10);
  ...
  describe('easing ->', function() {
    ...
    it('should parse standart easing', function() {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 49);
      expect(t.progress).toBe(0);
      expect(t.easedProgress).toBe(void 0);
      t.update(t._props.startTime + 50);
      return expect(t.easedProgress).toBe(mojs.easing.sin.out(t.progress));
    });
    ...
    it('should work with easing function', function(dfr) {
      ...
      t._setStartTime();
      t.update(t._props.startTime + 39);
      t.update(t._props.startTime + 40);
      return setTimeout((function() {
    ...
    describe('_prevTime recalculation ->', function() {
      ...
      it('should recalc _prevTime play + play', function(dfr) {
        ...
        return setTimeout(function() {
          ...
          var prevTime = t._props.startTime + t._progressTime;
  ...
  describe('play method ->', function() {
    ...
    it('should run if already playing but ended', function(dfr) {
      var duration, t;
      duration = 50;
      t = new Tween({ duration });

      t.play();
      return setTimeout(function() {
        spyOn(t, '_subPlay').and.callThrough();
        t.play();
  ...
  describe('callbacks order || forward ->', function() {
    it('should have the right order when normal direction || start', function() {
      ...
      tw._setStartTime();
      tw.update(tw._props.startTime);
      tw.update(tw._props.startTime + 10);
    ...
    it('should have the right order when normal direction || start #2', function() {
      ...
      tw._setStartTime();
      tw.update(tw._props.startTime);
      tw.update(tw._props.startTime + duration / 2);
      tw.update(tw._props.startTime + duration / 2 + 10);
      tw.update(tw._props.startTime + duration / 2 - 10);
      tw.update(tw._props.startTime);
      isReact = true;
      tw.update(tw._props.startTime + duration / 2);
    ...
    it('should have the right order when normal direction || end', function() {
      ...
      tw.update(tw._props.startTime + 10);
      tw.update(tw._props.startTime + duration / 2);
      tw.update(tw._props.startTime + duration);
      expect(order[0]).toBe('start');
      expect(order[1]).toBe('repeat-start');
      expect(order[2]).toBe('first-update');
      expect(order[3]).toBe('update');
    ...
    it('should have the right order when normal direction || repeat end', function() {
      ...
      tw.update(tw._props.startTime + 10);
      tw.update(tw._props.startTime + duration / 2);
      tw.update(tw._props.startTime + duration + 10);
      tw.update(tw._props.startTime + duration + duration / 2);
      tw.update(tw._props.startTime + duration + duration);
      expect(order[0]).toBe('start');
      expect(order[1]).toBe('repeat-start');
      expect(order[2]).toBe('first-update');
      expect(order[3]).toBe('update');
    ...
    return it('should have the right order when normal direction || end + delay', function() {
      ...
      tw.update(tw._props.startTime + 10);
      tw.update(tw._props.startTime + duration / 2);
      tw.update(tw._props.startTime + duration + delay / 2);
      tw.update(tw._props.startTime + duration + delay + 10);
      tw.update(tw._props.startTime + duration + delay + duration / 2);
  ...
  describe('callbacks order || backward ->', function() {
    it('should have the right order when reverse direction || start', function() {
      ...
      tw._setStartTime();
      tw.update(tw._props.startTime + duration - duration / 4);
      tw.update(tw._props.startTime + duration / 2);
    ...
    return it('should have the right order when reverse direction || end + delay #3', function() {
      ...
      tw.update(tw._props.startTime + duration / 2);
      tw.update(tw._props.startTime + duration);
      tw.update(tw._props.startTime + duration + delay);
      tw.update(tw._props.startTime + duration + delay + duration / 2);
      tw.update(tw._props.startTime + duration + delay + duration + 10);
      isReact = true;
      tw.update(tw._props.startTime + duration + delay + duration / 2);
      tw.update(tw._props.startTime + duration + delay + 10);
      tw.update(tw._props.startTime + duration + delay / 2);
  ...
  describe('setProgress method ->', function() {
    ...
    it('should call self update', function() {
      ...
      spyOn(t, 'update');
      t.setProgress(progress);
      return expect(t.update).toHaveBeenCalledWith(t._props.startTime + (progress * duration));
    });
    it('should not set the progress less then 0', function() {
      ...
      spyOn(t, 'update');
      t.setProgress(-1.5);
      return expect(t.update).toHaveBeenCalledWith(t._props.startTime - delay);
    });
    it('should not set the progress more then 1', function() {
      ...
      spyOn(t, 'update');
      t.setProgress(1.5);
      return expect(t.update).toHaveBeenCalledWith((t._props.startTime - delay) + t._props.repeatTime);
    });
  ...
  describe('onComplete callback ->', function() {
    ...
    // TODO: uncomment when `timeline` implemented
  ...
  describe('onProgress callback ->', function() {
    it('should be called with current progress and direction', function() {
      ...
      expect(parseFloat(tw._progress.calls.mostRecent().args[0].toFixed(5))).toBe(.5)
      expect(tw._progress.calls.mostRecent().args[1]).toBe(time)

      expect(parseFloat(tw._props.onProgress.calls.mostRecent().args[0].toFixed(5))).toBe(.5)
      expect(tw._props.onProgress.calls.mostRecent().args[1]).toBe(true)
    });
    ...
    it('should be called only once after active bounds "-"', function() {
      ...
      spyOn(tw, '_progress').and.callThrough();
      spyOn(tw._props, 'onProgress');
      tw.update(time - duration);
      tw.update(time - duration - 10);
  ...
  describe('onTweenerFinish method ->', function() {
  ...
  describe('_extendDefaults method ->', function() {
    it('should call super', function() {
      var tw;
      spyOn(ClassProto.prototype, '_extendDefaults').and.callThrough();
      tw = new Tween;
      tw._extendDefaults();
      return expect(ClassProto.prototype._extendDefaults).toHaveBeenCalled();
    });
    it('should parse easing', function() {
      var tw;
      tw = new Tween;
      tw._props.easing = 'cubic.in';
      tw._extendDefaults();
    ...
    it('should parse backwardEasing', function() {
      ...
      return expect(tw._props.backwardEasing).toBe(mojs.easing.cubic["in"]);
    });
    it('should set _parent on easing function', function() {
      var tw;
      tw = new Tween({
      ...
      expect(typeof tw._props.backwardEasing).toBe('function');
      expect(tw._props.backwardEasing).toBe(mojs.easing.cubic["in"]);
  ...
  describe('_assignProp method ->', function() {
    it('should parse easing', function() {
      var tr;
      tr = new Tween;
      tr._assignProp('easing', 'cubic.in');
  ...
  describe('_setResumeTime method ->', function() {
    ...
    describe('onRefresh callback ->', function() {
      it('should be called if time is less then startTime', function() {
        ...
        tw._setStartTime();
        p = tw._props;
        tw.update(p.startTime);
        tw.update(p.startTime + p.repeatTime / 2);
        tw.update(p.endTime);
        spyOn(tw, '_refresh');
        tw.update(p.endTime + 20);
        tw.update(p.startTime - 20);
        tw.update(p.startTime - 10);
