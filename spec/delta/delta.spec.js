...
//       isChained: true
//     });
//     expect(mojs.Tween.prototype._refresh).not.toHaveBeenCalled();
//   });
//
//   // 
//   describe('_calcCurrentProps method ->', function() {
//     it('should call sub functions based on each delta type', function() {
...
//     });
//     it('should calc color with curve', function() {
...
//     });
//     it('should calc number # curve', function() {
//       var delta, radiusDelta;
//       radiusDelta = h.parseDelta('radius', {
//         100: 100,
//         curve: 'M0,0 L100,50'
...
//     });
//     it('should calc unit based number # curve', function() {
//       var delta, xDelta;
//       xDelta = h.parseDelta('x', {
//         100: 100,
//         curve: 'M0,0 L100,50'
...
//       expect(delta._o.props['strokeDasharray']).toEqual('100px 50px ');
//     });
...
//       delta.tween = null;
//       delta._createTween(tweenOptions);
//       expect(typeof delta.tween._callbackOverrides.onRefresh).toBe('undefined');
//     });
...
//     });
//     it('should pass callbacksContext to tween', function() {
