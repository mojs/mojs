  ...
  _createClass(Shape, [{
    ...
    */
    ...
    value: function tune(o) {
      _get(Object.getPrototypeOf(Shape.prototype), 'tune', this).call(this, o);
    ...
    */
    ...
    value: function then(o) {
      // this._makeTimeline()
      _get(Object.getPrototypeOf(Shape.prototype), 'then', this).call(this, o);
      // update shapeModule's size to the max in `then` chain
      this._getMaxSizeInChain();
      return this;
    }
    ...
    */
    ...
    value: function _setElStyles() {
      ...
      if (p.isForce3d) {
        var _name = 'backface-visibility';
        style['' + _name] = 'hidden';
        style['' + h.prefix.css + _name] = 'hidden';
      }
      // }
    }
    ...
    */
    ...
    value: function _setProgress(easedProgress, progress) {
      ...
      _module3['default'].prototype._setProgress.call(this, easedProgress, progress);
