      ...
      if (!_h2['default'].isTweenProp(key) && !this._nonMergeProps[key] && !isBoolean) {
        ...
        if (this._isDelta(endValue)) {
          ...
          if (this._isDelta(startValue)) {
            ...
            return (_ref = {}, _defineProperty(_ref, _h2['default'].getDeltaEnd(startValue), parsedEndValue), _defineProperty(_ref, 'easing', easing), _defineProperty(_ref, 'curve', curve), _ref);
            // if both start and end value are not ∆ - make ∆
          } else {
              var _ref2;

              return (_ref2 = {}, _defineProperty(_ref2, startValue, parsedEndValue), _defineProperty(_ref2, 'easing', easing), _defineProperty(_ref2, 'curve', curve), _ref2);
            }
        }
