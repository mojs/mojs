    ...
    value: function _updateInActiveArea(time) {
      ...
      if (startPoint + elapsed >= props.startTime) {
        ...
        if (isOnEdge) {
          ...
          // |=====|=====|=====| >>>
          // ^!    ^here ^here
          this.o.isIt && console.log('heere 1');
          if (prevT >= 0) {
            this._repeatStart(time, isYoyo);
          }
        }
        ...
        if (isOnReverseEdge) {
          ...
          if (this.progress !== 0 && this.progress !== 1 && prevT != TCount) {
            this.o.isIt && console.log('heere 2', T, prevT);
          ...
          if (prevT === TCount && !this._wasUknownUpdate) {
            this.o.isIt && console.log('here 6', prevT, TCount, time, this._prevTime);
            this._complete(time, isYoyo);
            this._repeatComplete(time, isYoyo);
            this._firstUpdate(time, isYoyo);
        ...
        if (prevT === 'delay') {
          ...
          // |---=====|---=====|---=====| >>>
          //            ^1  ^2
          this.o.isIt && console.log('heere 3');
          if (T === TPrevValue && T > 0) {
            this._repeatStart(time, isYoyo);
          }
        }
        ...
        if (time > this._prevTime) {
          ...
          if (proc === 0) {
            this.o.isIt && console.log('heere 4');
            this._repeatStart(time, isYoyo);
          }
          ...
          // if progress is equal 0 and progress grows
          this.o.isIt && console.log('heere 6');
          if (proc === 0) {
            this._repeatStart(time, isYoyo);
          }
        }
        ...
        // delay gap - react only once
          ...
          if (time < this._prevTime) {
            ...
            this.o.isIt && console.log('heere 7');
