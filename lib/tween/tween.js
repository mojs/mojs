  ...
  _createClass(Tween, [{
    ...
    */
    ...
    value: function _extendDefaults() {
      ...
      //   this._props[key] = (this._o[key] != null) ? this._o[key] : this._defaults[key];
      // }
      ...
      this._props.easing = _easingEasing2['default'].parseEasing(this._o.easing || this._defaults.easing);
