  ...
  _createClass(Tween, [{
    ...
    */
    ...
    value: function _getPeriod(time) {
      ...
      var startPoint = props.startTime;
      this.o.isIt2 && console.log('-------------------------------------------------');
      this.o.isIt2 && console.log('-------------------------------------------------');
      this.o.isIt2 && console.log('-------------------------------------------------');
      this.o.isIt2 && console.log('time: ' + time + ', start: ' + props.startTime + ', end: ' + props.endTime);
      this.o.isIt2 && console.log(time - props.startTime);
      this.o.isIt2 && this._visualizeProgress(time);
      var res = Math.floor((time - props.startTime + props.delay) / (props.delay + props.duration));

      var elapsed = (time - props.startTime + props.delay) % (props.delay + props.duration);

      if (elapsed === 0 && props.delay > 0) {
        res--;
      }

      this.o.isIt2 && console.log('elapsed: ' + elapsed, 'T: ' + res);
