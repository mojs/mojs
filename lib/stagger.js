  ...
  _createClass(Stagger, [{
    ...
    */
    ...
    value: function _getChildQuantity(name, store) {
      ...
      if (_h2['default'].isArray(quantifier)) return quantifier.length;else if (quantifier + '' === '[object NodeList]') return quantifier.length;else if (quantifier + '' === '[object HTMLCollection]') return Array.prototype.slice.call(quantifier, 0).length;else if (quantifier instanceof HTMLElement) return 1;else if (typeof quantifier == 'string') return 1;
    }
