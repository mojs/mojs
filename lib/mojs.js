...
window.mojs = {
  ...
  Tween: _tweenTween2['default'], Timeline: _tweenTimeline2['default'], tweener: _tweenTweener3['default'], easing: _easingEasing2['default'], shapesMap: _shapesShapesMap2['default']
};
