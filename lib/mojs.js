...
window.mojs = {
  ...
  Tween: _tweenTween2['default'], Timeline: _tweenTimeline2['default'], Tweenable: _tweenTweenable2['default'], Thenable: _thenable2['default'], tweener: _tweenTweener3['default'], easing: _easingEasing2['default'],
  shapesMap: _shapesShapesMap2['default']
};
...
}).then({ radius: 5, shape: 'rect' });

tr.el.style.display = 'block';
tr._modules[1].el.style.display = 'block';
console.log(tr.el);
