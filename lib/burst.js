  ...
  _createClass(Burst, [{
    ...
    */
    ...
    value: function _extendDefaults() {
      var childOptions = {};
      // childOptions = this._o.childOptions;
      // delete this._o.childOptions;
    ...
    */
    ...
    value: function _mergeThenOptions(start, end) {
      var startChild = start.childOptions || {},
          ...
          mergedChild = _get(Object.getPrototypeOf(Burst.prototype), '_mergeThenOptions', this).call(this, startChild, endChild, false),
          merged = _get(Object.getPrototypeOf(Burst.prototype), '_mergeThenOptions', this).call(this, start, end, false);
