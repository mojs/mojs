...
var Burst = (function (_Tunable) {
  ...
  _createClass(Burst, [{
    ...
    */
    ...
    key: '_getBitAngle',
    value: function _getBitAngle(angleProperty, angleShift, i) {
      if (angleProperty === undefined) angleProperty = 0;
      if (angleShift === undefined) angleShift = 0;
...
var ChildSwirl = (function (_ShapeSwirl) {
  _inherits(ChildSwirl, _ShapeSwirl);

  function ChildSwirl() {
    _classCallCheck(this, ChildSwirl);

    _get(Object.getPrototypeOf(ChildSwirl.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(ChildSwirl, [{
    key: '_declareDefaults',
    value: function _declareDefaults() {
      _get(Object.getPrototypeOf(ChildSwirl.prototype), '_declareDefaults', this).call(this);
...
var MainSwirl = (function (_ChildSwirl) {
  _inherits(MainSwirl, _ChildSwirl);

  function MainSwirl() {
    _classCallCheck(this, MainSwirl);

    _get(Object.getPrototypeOf(MainSwirl.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(MainSwirl, [{
    key: '_declareDefaults',
    value: function _declareDefaults() {
      _get(Object.getPrototypeOf(MainSwirl.prototype), '_declareDefaults', this).call(this);
