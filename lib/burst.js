  ...
  _createClass(Burst, [{
    ...
    */
    ...
    value: function _getOption(i) {
      ...
      for (var key in this._childDefaults) {
        ...
        prop = _h2['default'].parseIfRand(prop);
    ...
    */
    ...
    value: function _getBitAngle(angle, i) {
      ...
      if (!this._isDelta(angle)) {
        ...
        start = _h2['default'].parseIfStagger(start, i);
        start = _h2['default'].parseIfRand(start);
        end = _h2['default'].parseIfStagger(end, i);
        end = _h2['default'].parseIfRand(end);

        var newStart = parseFloat(start) + angleAddition,
    ...
    */
    ...
    value: function _makeTimeline() {
      ...
      (_timeline = this.timeline).add.apply(_timeline, _toConsumableArray(this._swirls));
    }
