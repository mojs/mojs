    ...
    */
    ...
    value: function _setProgress(proc) {
      var p = this._props,
          ...
          angle2 = p.isSwirl ? angle + this._getSwirl(proc) : angle;

      console.log('angle2: ' + angle2);

      var point = _h2['default'].getRadialPoint({
        angle: angle2,
      ...
      _get(Object.getPrototypeOf(Swirl.prototype), '_setProgress', this).call(this, proc);
    }
