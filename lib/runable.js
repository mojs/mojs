    ...
    value: function _transformHistoryRecord(index, key, value) {
      ...
      if (this._isDelta(value)) {
        ...
        if (prevRecord && prevRecord[key] === value) {
          ...
          currRecord[key] = _defineProperty({}, prevEnd, _h2['default'].getDeltaEnd(propertyValue));
          return true;
        ...
        if (this._isDelta(propertyValue)) {
          currRecord[key] = _defineProperty({}, value, _h2['default'].getDeltaEnd(propertyValue));
          return true;
